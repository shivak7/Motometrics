function varargout = session_manager(varargin)
% SESSION_MANAGER MATLAB code for session_manager.fig
%      SESSION_MANAGER, by itself, creates a new SESSION_MANAGER or raises the existing
%      singleton*.
%
%      H = SESSION_MANAGER returns the handle to a new SESSION_MANAGER or the handle to
%      the existing singleton*.
%
%      SESSION_MANAGER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SESSION_MANAGER.M with the given input arguments.
%
%      SESSION_MANAGER('Property','Value',...) creates a new SESSION_MANAGER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before session_manager_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to session_manager_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help session_manager

% Last Modified by GUIDE v2.5 19-Oct-2016 11:51:47

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @session_manager_OpeningFcn, ...
                   'gui_OutputFcn',  @session_manager_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before session_manager is made visible.
function session_manager_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to session_manager (see VARARGIN)

% Choose default command line output for session_manager
...
% UIWAIT makes session_manager wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = session_manager_OutputFcn(hObject, eventdata, handles) 
